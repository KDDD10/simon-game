...
function playSound(soundName) {
    ...
    switch (soundName) {
        case "coin":
            audio = new Audio("resources/audios/coin_sound.wav");
            break;
        case "win":
            audio = new Audio("resources/audios/win.wav");
            break;
        case "lose":
            audio = new Audio("resources/audios/lose.wav");
            break;
        case "try":
            audio = new Audio("resources/audios/try.wav");
            break;
        case "start":
            audio = new Audio("resources/audios/start.wav");
            break;
        default:
            return; 
    }
